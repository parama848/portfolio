...
//         {/* Cards */}
//         <div className="w-full overflow-x-auto snap-x snap-mandatory hide-scrollbar pt-16">
...
//                 <div
//                   key={project._id}
//                   className={`flip-card w-[320px] min-h-[500px] flex-shrink-0 snap-start ${
//                     activeCard === index
//                       ? "active"
//                       : ""
//                   }`}
...
//                         delay: index * 0.15,
//                       }}
//                       className="flip-front bg-black/70 backdrop-blur border border-white rounded-tl-3xl rounded-br-3xl p-5 flex flex-col"
//                     >
//                       {/* Image */}
//                       <img
//                         src={project.image}
...
//                             <span
//                               key={i}
//                               className="bg-white/10 border border-white/10 text-gray-200 px-4 py-2 rounded-xl text-sm"
//                             >
//                               {tech}
//                             </span>
//                           )
...
//                             e.stopPropagation()
//                           }
//                           className="flex-1 bg-white text-black text-center py-3 rounded-2xl font-medium"
//                         >
//                           Live Demo
//                         </a>
...
//                             e.stopPropagation()
//                           }
//                           className="flex-1 border border-white py-3 rounded-2xl flex items-center justify-center gap-2 font-medium"
//                         >
//                           <FaGithub />
//                           Code
//                         </a>
